...
const translations = {
  ua: {
    ...
    navAboutTextPtwo: "Маю міцні знання HTML та CSS, вмію створювати адаптивні і привабливі інтерфейси, що працюють на різних пристроях.",
    navAboutTextPthree: "Працюю над проектами, щоб покращувати навички і освоювати нові технології крок за кроком.",
    navAboutTextPfour: "Вірю, що постійне навчання і практика — це ключ до успіху у IT-сфері.",
    navAboutTextPfive: "Я відкритий до нових викликів і готовий долучатися до цікавих проектів, де зможу застосувати свої знання і продовжувати рости.",
        navAboutTextPsix: "Якщо шукаєш мотивованого і цілеспрямованого розробника, який швидко вчиться — зв'яжись зі мною!",
    ...
    navPortfolioPfive: "Опис: односторінковий адаптивний сайт, створений у рамках домашнього завдання №6 курсу GoIT. Сайт демонструє можливості веб-студії, що спеціалізується на цифровому дизайні та маркетингових рішеннях.",
    navPortfolioHsix: "Яхти",
    navPortfolioPsix: "Опис: односторінковий сайт, розроблений у рамках командного проєкту, що демонструє можливості оренди розкішних яхт для подорожей. Сайт поєднує елегантний дизайн із зручним функціоналом для перегляду флоту та відгуків клієнтів.",
    navPortfolioHseven: "Сайт погоди",
    navPortfolioPseven: "Опис: Сайт погоди – веб-додаток для перегляду прогнозу погоди в обраних містах. Підтримує погодинний та денний прогноз, автодоповнення при введенні міста та кілька мов (чеська, українська, англійська).",
    navPortfolioHeight: "SWES Reservation Module",
    navPortfolioPeight: "Опис: Інтерфейс для бронювання та управління обладнанням у компанії. Користувачі можуть створювати бронювання, переглядати історію, фільтрувати за типом та статусом, а також переглядати календар.",
...
navPortfolioPoneVQQ:"Опис: каталог музичних виконавців, їхніх пісень, біографій та відгуків. Робив Хедер. Спільний, командний проект.",
...
navPortfolioCSSJ:"JS - Використано;",
  ...
  en: {
    navPortfolioPoneVQQ:"Description: a catalog of music artists, their songs, biographies, and reviews. Worked on the Header. A shared, team project.",
  navPortfolioJSQQ: "JavaScript - Used;",
    ...
    navAboutTextPtwo: "I have solid knowledge of HTML and CSS, and I can create adaptive and attractive interfaces that work across different devices.",
    navAboutTextPthree: "I work on projects to improve my skills and master new technologies step by step.",
    navAboutTextPfour: "I believe that continuous learning and practice are the key to success in the IT field.",
    navAboutTextPfive: "I am open to new challenges and ready to join interesting projects where I can apply my knowledge and continue to grow.",
      navAboutTextPsix: "If you are looking for a motivated and determined developer who learns quickly — get in touch with me!",
    ...
    navPortfolioPfive: "Description: a one-page responsive website created as part of homework #6 of the GoIT course. Showcases the capabilities of a web studio specializing in digital design and marketing solutions.",
    navPortfolioHsix: "Yachts",
    navPortfolioPsix: "Description: a one-page website developed as a team project, showcasing luxury yacht rental options for trips. Combines elegant design with user-friendly fleet and review browsing functionality.",
    navPortfolioHseven: "Weather Website",
    navPortfolioPseven: "Description: a web application for checking the weather forecast in selected cities. Supports hourly and daily forecasts, auto-complete when entering city names, and multiple languages (Czech, Ukrainian, English).",
    navPortfolioHeight: "SWES Reservation Module",
    navPortfolioPeight: "Description: Interface for booking and managing company equipment. Users can create bookings, view history, filter by type and status, and check the calendar.",
...
navPortfolioCSSJ: "JavaScript – Used;",
  ...
  cz: {
        navPortfolioPoneVQQ:"Popis: katalog hudebních umělců, jejich písní, biografií a recenzí. Pracoval na hlavičce. Sdílený týmový projekt.",
    ...
    navAboutTextPtwo: "Mám pevné znalosti HTML a CSS, umím vytvářet responzivní a atraktivní rozhraní, která fungují na různých zařízeních.",
    navAboutTextPthree: "Pracuji na projektech, abych zlepšil své dovednosti a krok za krokem ovládal nové technologie.",
    navAboutTextPfour: "Věřím, že neustálé učení a praxe jsou klíčem k úspěchu v IT oblasti.",
    navAboutTextPfive: "Jsem otevřený novým výzvám a připravený zapojit se do zajímavých projektů, kde mohu uplatnit své znalosti a dále růst.",
      navAboutTextPsix: "Pokud hledáš motivovaného a cílevědomého vývojáře, který se rychle učí — kontaktuj mě!",
    ...
    navPortfolioHfive: "Web Studio",
    navPortfolioPfive: "Popis: jednorázová responzivní stránka vytvořená v rámci domácího úkolu č. 6 kurzu GoIT. Ukazuje možnosti webového studia specializujícího se na digitální design a marketingová řešení.",
    navPortfolioHsix: "Jachty",
    navPortfolioPsix: "Popis: jednorázová stránka vyvinutá jako týmový projekt, ukazující možnosti pronájmu luxusních jachet pro cestování. Kombinuje elegantní design s uživatelsky přívětivým prohlížením flotily a recenzí.",
    navPortfolioHseven: "Počasí Web",
    navPortfolioPseven: "Popis: webová aplikace pro kontrolu předpovědi počasí ve vybraných městech. Podporuje hodinové a denní předpovědi, automatické doplňování při zadávání měst a několik jazyků (čeština, ukrajinština, angličtina).",
    navPortfolioHeight: "SWES Reservation Module",
    navPortfolioPeight: "Popis: rozhraní pro rezervaci a správu vybavení ve společnosti. Uživatelé mohou vytvářet rezervace, prohlížet historii, filtrovat podle typu a stavu a kontrolovat kalendář.",
