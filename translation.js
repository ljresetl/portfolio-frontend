...
const translations = {
  ua: {
    ...
    navPortfolioPtwo: "Опис: односторінковий сайт, що надає користувачам можливість переглядати фільми та серіали українською мовою. Інтерфейс сайту простий і зручний, з адаптивним дизайном.",
    ...
    navPortfolioPfour: "Опис: односторінковий сайт, який демонструє можливості платформи для тестування та валідації продуктів. Сайт орієнтований на стартапи та компанії, які прагнуть оптимізувати свої продукти.",
...
navPortfolioCSSJ:"JS - Використано;",
    navPortfolioHtwoVQQQ: "Додаток фільмів",
navPortfolioPoneVQQQ: "Опис: React Movies – вебдодаток для перегляду інформації про фільми.",
  },
  en: {
  ...
  navPortfolioJSQQ: "JavaScript - Used;",
    ...
    navPortfolioPtwo: "Description: a one-page website that allows users to watch movies and series in Ukrainian. The interface is simple and convenient.",
    ...
    navPortfolioPfour: "Description: a one-page website showcasing a platform for testing and validating products. Targeted at startups and companies looking to optimize products.",
...
navPortfolioCSSJ: "JavaScript – Used;",
    navPortfolioHtwoVQQQ: "Movie App",
navPortfolioPoneVQQQ: "Description: React Movies – a web app for browsing movie information.",
  ...
  cz: {
    ...
    navPortfolioPtwo: "Popis: jednorázová stránka, která umožňuje uživatelům sledovat filmy a seriály v ukrajinštině. Rozhraní je jednoduché a pohodlné.",
    navPortfolioHthree: "Barbershop",
    ...
    navPortfolioPfour: "Popis: jednorázová stránka, která ukazuje možnosti platformy pro testování a validaci produktů. Stránka je zaměřena na startupy a firmy, které chtějí optimalizovat své produkty.",
    navPortfolioHfive: "Web Studio",
...
navPortfolioCSSJ: "JavaScript – Použito;",
    navPortfolioHtwoVQQQ: "Aplikace Filmů",
navPortfolioPoneVQQQ: "Popis: React Movies – webová aplikace pro prohlížení informací o filmech.",
